...
mixin _$Candidate {
  ...
  @JsonKey(name: 'cogn')
  String get cogn => throw _privateConstructorUsedError;
  @JsonKey(name: 'ruolo')
...
abstract class $CandidateCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'cogn') String cogn,
      @JsonKey(name: 'ruolo') String ruolo});
}
...
class _$CandidateCopyWithImpl<$Res> implements $CandidateCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      cogn: cogn == freezed
          ? _value.cogn
          : cogn // ignore: cast_nullable_to_non_nullable
              as String,
      ruolo: ruolo == freezed
          ? _value.ruolo
...
/// @nodoc
@JsonSerializable()
class _$_Candidate with DiagnosticableTreeMixin implements _Candidate {
  const _$_Candidate(
      {@JsonKey(name: 'nome') required this.nome,
      @JsonKey(name: 'cogn') required this.cogn,
      @JsonKey(name: 'ruolo') required this.ruolo});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Candidate(nome: $nome, cogn: $cogn, ruolo: $ruolo)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('cogn', cogn))
      ..add(DiagnosticsProperty('ruolo', ruolo));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.cogn, cogn) &&
            const DeepCollectionEquality().equals(other.ruolo, ruolo));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(cogn),
      const DeepCollectionEquality().hash(ruolo));
...
abstract class _Candidate implements Candidate {
  const factory _Candidate(
      {@JsonKey(name: 'nome') required final String nome,
      @JsonKey(name: 'cogn') required final String cogn,
      @JsonKey(name: 'ruolo') required final String ruolo}) = _$_Candidate;
